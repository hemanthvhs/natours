      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            ...
            stripe = Stripe('pk_test_51JFt8QSCjDtYPElvbsZtH8UiMJH5ijuObjOXuVcqO1F76ptZN9vU2HeCOIG9RX8D0MGo4LES0mihotvLpArdzvnx00rFbNmJXk'); // 2) Get the stripe checkout session from the server
...
if (bookBtnEl) {
  ...
  bookBtnEl.addEventListener('click', /*#__PURE__*/function () {
        ...
        while (1) {
          switch (_context2.prev = _context2.next) {
            case 0:
              ...
              tourId = e.target.dataset.tourId; // If your data attrribute is data-tour-id then to access that we use as dataset.tourId (Here 'I' should be capital since we have '-' between tour and id in tour-id)
...
},{"regenerator-runtime/runtime":"../../node_modules/regenerator-runtime/runtime.js","./login":"login.js","./mapbox":"mapbox.js","./updateSettings":"updateSettings.js","./stripe":"stripe.js"}],"../../node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
